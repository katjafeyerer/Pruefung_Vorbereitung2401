...
public class MinMaxTest {
	...
	@Test
	public void getMinMaxSingleResult1() {
		List<String> ls = ts.getMinMaxPreOrder2(1.0, 1.5);
		assertEquals(1, ls.size());
		assertEquals("Office Space", ls.get(0));
	}

	@Test
	public void getMinMaxSomeResults11() {
		List<String> ls = ts.getMinMaxPreOrder2(1.75, 1.92);
		assertEquals(3, ls.size());
		assertEquals("Stranger than Fiction", ls.get(0));
		assertEquals("Gattaca", ls.get(1));
		assertEquals("Adaption", ls.get(2));
	...
	@Test
	public void getMinMaxSomeResults21() {
		List<String> ls = ts.getMinMaxPreOrder2(1.92, 2.1);
		assertEquals(3, ls.size());
		assertEquals("Pleasantville", ls.get(0));
		assertEquals("Alien", ls.get(1));
		assertEquals("The Great Dictator", ls.get(2));
	...
	@Test
	public void getMinMaxAlmostAllResults1() {
		List<String> ls = ts.getMinMaxPreOrder2(1.69, 2.1);
		assertEquals(7, ls.size());
		assertEquals("Stranger than Fiction", ls.get(0));
		assertEquals("Ferris Bueller's Day Off", ls.get(1));
		assertEquals("Gattaca", ls.get(2));
	...
	@Test
	public void getMinMaxNoResult1() {
		List<String> ls = ts.getMinMaxPreOrder2(1.0, 1.2);
		assertEquals(0, ls.size());
		ls = ts.getMinMaxPreOrder(2.4, 2.5);
		assertEquals(0, ls.size());
	}
